package com.leonardo.pontointeligente.api.controllers;
...
import com.leonardo.pontointeligente.api.dtos.LancamentoDto;
...
public class LancamentoController {
	...
	private Lancamento converterDtoParaLancamento(LancamentoDto lancamentoDto, BindingResult result)
		...
		if (EnumUtils.isValidEnum(TipoPontoEnum.class, lancamentoDto.getTipo())) {
			lancamento.setTipo(TipoPontoEnum.valueOf(lancamentoDto.getTipo()));
		} else {
